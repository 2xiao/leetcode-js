...
| 397 | [整数替换](https://leetcode.com/problems/integer-replacement) |  |  [`贪心`](/outline/tag/greedy.md) [`位运算`](/outline/tag/bit-manipulation.md) [`记忆化搜索`](/outline/tag/memoization.md) `1+` | <font color=#ffb800>Medium</font> |
...
| 964 | [表示数字的最少运算符](https://leetcode.com/problems/least-operators-to-express-number) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`数学`](/outline/tag/math.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 1387 | [将整数按权重排序](https://leetcode.com/problems/sort-integers-by-the-power-value) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`动态规划`](/outline/tag/dynamic-programming.md) [`排序`](/outline/tag/sorting.md) | <font color=#ffb800>Medium</font> |
...
| 1553 | [吃掉 N 个橘子的最少天数](https://leetcode.com/problems/minimum-number-of-days-to-eat-n-oranges) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 1575 | [统计所有可行路径](https://leetcode.com/problems/count-all-possible-routes) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`数组`](/outline/tag/array.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 1900 | [最佳运动员的比拼回合](https://leetcode.com/problems/the-earliest-and-latest-rounds-where-players-compete) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 2311 | [小于等于 K 的最长二进制子序列](https://leetcode.com/problems/longest-binary-subsequence-less-than-or-equal-to-k) |  |  [`贪心`](/outline/tag/greedy.md) [`记忆化搜索`](/outline/tag/memoization.md) [`字符串`](/outline/tag/string.md) `1+` | <font color=#ffb800>Medium</font> |
...
| 2876 | [有向图访问计数](https://leetcode.com/problems/count-visited-nodes-in-a-directed-graph) |  |  [`图`](/outline/tag/graph.md) [`记忆化搜索`](/outline/tag/memoization.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 3040 | [相同分数的最大操作数目 II](https://leetcode.com/problems/maximum-number-of-operations-with-the-same-score-ii) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`数组`](/outline/tag/array.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ffb800>Medium</font> |
...
| LCP 20 | [快速公交](https://leetcode.cn/problems/meChtZ) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`数组`](/outline/tag/array.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
...
| 剑指 Offer 10 - I | [斐波那契数列](https://leetcode.cn/problems/fei-bo-na-qi-shu-lie-lcof) | [[✓]](/problem/jz_offer_10_1) |  [`记忆化搜索`](/outline/tag/memoization.md) [`数学`](/outline/tag/math.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#15bd66>Easy</font> |
| 剑指 Offer 10 - II | [青蛙跳台阶问题](https://leetcode.cn/problems/qing-wa-tiao-tai-jie-wen-ti-lcof) | [[✓]](/problem/jz_offer_10_2) |  [`记忆化搜索`](/outline/tag/memoization.md) [`数学`](/outline/tag/math.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#15bd66>Easy</font> |
...
| 面试题 08.01 | [三步问题](https://leetcode.cn/problems/three-steps-problem-lcci) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`数学`](/outline/tag/math.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#15bd66>Easy</font> |
| 面试题 08.14 | [布尔运算](https://leetcode.cn/problems/boolean-evaluation-lcci) |  |  [`记忆化搜索`](/outline/tag/memoization.md) [`字符串`](/outline/tag/string.md) [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ffb800>Medium</font> |
