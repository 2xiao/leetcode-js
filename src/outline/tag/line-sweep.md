...
| 391 | [完美矩形](https://leetcode.com/problems/perfect-rectangle) |  |  [`数组`](/outline/tag/array.md) [`扫描线`](/outline/tag/line-sweep.md) | <font color=#ff334b>Hard</font> |
...
| 1851 | [包含每个查询的最小区间](https://leetcode.com/problems/minimum-interval-to-include-each-query) |  |  [`数组`](/outline/tag/array.md) [`二分查找`](/outline/tag/binary-search.md) [`排序`](/outline/tag/sorting.md) `2+` | <font color=#ff334b>Hard</font> |
