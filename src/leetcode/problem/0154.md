...
Given the sorted rotated array `nums` that may contain _duplicates_, return the minimum element of this array.
...
**注意：** 本题是「[153. 寻找旋转排序数组中的最小值](./0153.md)」的延伸，区别是数组中可能存在重复的元素。
