...
- [拼接数组的最大分数](https://leetcode.com/problems/maximum-score-of-spliced-array)
- [任意子数组和的绝对值的最大值](https://leetcode.com/problems/maximum-absolute-sum-of-any-subarray)
- [经过一次操作后的最大子数组和](https://leetcode.com/problems/maximum-subarray-sum-after-one-operation)
- [最大波动的子字符串](https://leetcode.com/problems/substring-with-largest-variance)
- [统计得分小于 K 的子数组数目](https://leetcode.com/problems/count-subarrays-with-score-less-than-k)
- [数组中字符串的最大值](https://leetcode.com/problems/maximum-value-of-a-string-in-an-array)
- [找到最大开销的子字符串](https://leetcode.com/problems/find-the-substring-with-maximum-cost)
- [K 件物品的最大和](https://leetcode.com/problems/k-items-with-the-maximum-sum)
- [最大好子数组和](https://leetcode.com/problems/maximum-good-subarray-sum)
