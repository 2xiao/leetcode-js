...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`栈`](/leetcode/outline/tag/stack.md) [`设计`](/leetcode/outline/tag/design.md) [`数组`](/leetcode/outline/tag/array.md) [`链表`](/leetcode/outline/tag/linked-list.md) [`数据流`](/leetcode/outline/tag/data-streams.md) [`双向链表`](/leetcode/outline/tag/doubly-linked-list.md)
