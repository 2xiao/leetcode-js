...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数学`](/outline/tag/math.md) [`字符串`](/outline/tag/string.md) [`模拟`](/outline/tag/simulation.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/multiply-strings)
...
| 2288 | [价格减免](https://leetcode.com/problems/apply-discount-to-prices) |  |  [`字符串`](/outline/tag/string.md) | <font color=#ffb800>Medium</font> |
