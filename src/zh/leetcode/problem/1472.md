...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`栈`](../solution/stack.md) [`设计`](../solution/design.md) [`数组`](../solution/array.md) [`链表`](../solution/linked-list.md) [`数据流`](../solution/data-streams.md) [`双向链表`](../solution/doubly-linked-list.md)
