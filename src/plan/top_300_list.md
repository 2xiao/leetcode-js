...
| 773 | 滑动谜题 |  |  [`广度优先搜索`](/tag/breadth-first-search.md) [`数组`](/tag/array.md) [`矩阵`](/tag/matrix.md) | 🔴 | [🀄️](https://leetcode.cn/problems/sliding-puzzle) [🔗](https://leetcode.com/problems/sliding-puzzle) |
