import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o as i,c as u,a as s,b as n,d as a,w as t,e as r}from"./app-xC9zt8nl.js";const k={},d={id:"_59-spiral-matrix-ii",tabindex:"-1"},m=s("a",{class:"header-anchor",href:"#_59-spiral-matrix-ii","aria-hidden":"true"},"#",-1),v={href:"https://leetcode.com/problems/spiral-matrix-ii/",target:"_blank",rel:"noopener noreferrer"},b=s("code",null,"数组",-1),h=s("code",null,"矩阵",-1),f=s("code",null,"模拟",-1),_=r(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Given a positive integer <em>n</em>, generate a square matrix filled with elements from 1 to <em>n</em>2 in spiral order.</p><p><strong>Example</strong>:</p><pre><code>Input: 3
Output:
[
 [ 1, 2, 3 ],
 [ 8, 9, 4 ],
