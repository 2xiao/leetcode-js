import{_ as d,r as i,o,c as r,a as e,b as n,d as a,w as t,e as c}from"./app-fBVbqwGY.js";const u={},p=e("h1",{id:"_2881-创建新列",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2881-创建新列","aria-hidden":"true"},"#"),n(" 2881. 创建新列")],-1),v={href:"https://leetcode.cn/problems/create-a-new-column",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/create-a-new-column",target:"_blank",rel:"noopener noreferrer"},h=e("code",null,"LeetCode",-1),g=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame <code>employees</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type.  |
+-------------+--------+
| name        | object |
| salary      | int.   |
