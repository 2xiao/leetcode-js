import{_ as o,r as a,o as r,c,a as e,b as n,d as s,w as i,f as u,e as p}from"./app-fBVbqwGY.js";const v={},m=e("h1",{id:"_175-组合两个表",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_175-组合两个表","aria-hidden":"true"},"#"),n(" 175. 组合两个表")],-1),b=e("code",null,"数据库",-1),h={href:"https://leetcode.cn/problems/combine-two-tables",target:"_blank",rel:"noopener noreferrer"},g=e("code",null,"力扣",-1),x={href:"https://leetcode.com/problems/combine-two-tables",target:"_blank",rel:"noopener noreferrer"},_=e("code",null,"LeetCode",-1),f=p(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Table: <code>Person</code></p><blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+---------+
| Column Name | Type    |
+-------------+---------+
| personId    | int     |
| lastName    | varchar |
