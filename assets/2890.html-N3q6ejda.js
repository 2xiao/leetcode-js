import{_ as t,r,o as l,c as d,a as e,b as n,d as a,w as o,e as c}from"./app-ATuw4JGh.js";const u={},p=e("h1",{id:"_2890-重塑数据-融合",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2890-重塑数据-融合","aria-hidden":"true"},"#"),n(" 2890. 重塑数据：融合")],-1),v={href:"https://leetcode.cn/problems/reshape-data-melt",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/reshape-data-melt",target:"_blank",rel:"noopener noreferrer"},g=e("code",null,"LeetCode",-1),_=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame report</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| product     | object |
| quarter_1   | int    |
