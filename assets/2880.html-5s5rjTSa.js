import{_ as d,r as t,o,c as l,a as n,b as e,d as s,w as c,e as u}from"./app-kgZn1k0Y.js";const p={},r=n("h1",{id:"_2880-数据选取",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2880-数据选取","aria-hidden":"true"},"#"),e(" 2880. 数据选取")],-1),v={href:"https://leetcode.cn/problems/select-data",target:"_blank",rel:"noopener noreferrer"},m=n("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/select-data",target:"_blank",rel:"noopener noreferrer"},k=n("code",null,"LeetCode",-1),g=u(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame <code>students</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| student_id  | int    |
| name        | object |
