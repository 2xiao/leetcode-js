import{_ as d,r as t,o as c,c as r,a as n,b as e,d as s,w as l,f as p,e as u}from"./app-kgZn1k0Y.js";const v={},m=n("h1",{id:"_177-第-n-高的薪水",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_177-第-n-高的薪水","aria-hidden":"true"},"#"),e(" 177. 第 N 高的薪水")],-1),b=n("code",null,"数据库",-1),h={href:"https://leetcode.cn/problems/nth-highest-salary",target:"_blank",rel:"noopener noreferrer"},g=n("code",null,"力扣",-1),k={href:"https://leetcode.com/problems/nth-highest-salary",target:"_blank",rel:"noopener noreferrer"},_=n("code",null,"LeetCode",-1),x=u(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Table: <code>Employee</code></p><blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+------+
| Column Name | Type |
+-------------+------+
| id          | int  |
| salary      | int  |
