import{_ as l,r as i,o as t,c as o,a as e,b as n,d as a,w as r,e as c}from"./app-fBVbqwGY.js";const u={},p=e("h1",{id:"_2883-删去丢失的数据",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2883-删去丢失的数据","aria-hidden":"true"},"#"),n(" 2883. 删去丢失的数据")],-1),v={href:"https://leetcode.cn/problems/drop-missing-data",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/drop-missing-data",target:"_blank",rel:"noopener noreferrer"},g=e("code",null,"LeetCode",-1),h=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame <code>students</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| student_id  | int    |
| name        | object |
