import{_ as o,r as p,o as i,c as l,a as n,b as s,d as a,e as t}from"./app-d_olGygv.js";const c={},r=n("h1",{id:"_1-项目框架搭建",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-项目框架搭建","aria-hidden":"true"},"#"),s(" 1. 项目框架搭建")],-1),u={class:"hint-container info"},d=n("p",{class:"hint-container-title"},"摘要",-1),v=n("ul",null,[n("li",null,"选择项目结构（Mono-repo）"),n("li",null,"定义开发规范（eslint、commitlint、tsc、prettier）"),n("li",null,"选择打包工具（rollup）")],-1),m={href:"https://github.com/2xiao/my-react/tree/v1.1",target:"_blank",rel:"noopener noreferrer"},k=n("code",null,"git tag v1.1",-1),b=t(`<h2 id="_1-选择项目结构" tabindex="-1"><a class="header-anchor" href="#_1-选择项目结构" aria-hidden="true">#</a> 1. 选择项目结构</h2><p>选择 Multi-repo 还是 Mono-repo？</p><ul><li>Multi-repo 每个库都有独立的仓库，逻辑清晰，但协同管理会更繁琐；</li><li>Mono-repo 可以方便的协同管理不同独立的库的生命周期，但是会有更高的操作复杂度。</li></ul><p>很多大型项目都使用 Mono-repo 结构管理，比如 Vue，Bable，我们也选择 Mono-repo。</p><h2 id="_2-选择-mono-repo-工具" tabindex="-1"><a class="header-anchor" href="#_2-选择-mono-repo-工具" aria-hidden="true">#</a> 2. 选择 Mono-repo 工具</h2><p>简单工具：</p><ul><li>npm workspace</li><li>Yarn workspace</li><li>pnpm workspace</li></ul><p>专业工具：</p><ul><li>nx</li><li>bit</li><li>turborepo</li><li>rush</li><li>nx</li><li>lerna</li></ul><p>我们选择 <code>pnpm</code>,因为它相比其它打包工具，依赖安装更快，更规范（处理幽灵依赖问题）。</p><p>安装 <code>pnpm</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install -g pnpm
