import{_ as d,r as i,o as t,c as o,a as e,b as n,d as a,w as r,e as c}from"./app-aQeLbVW9.js";const u={},v=e("h1",{id:"_2889-数据重塑-透视",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2889-数据重塑-透视","aria-hidden":"true"},"#"),n(" 2889. 数据重塑：透视")],-1),p={href:"https://leetcode.cn/problems/reshape-data-pivot",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/reshape-data-pivot",target:"_blank",rel:"noopener noreferrer"},h=e("code",null,"LeetCode",-1),g=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame weather</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| city        | object |
| month       | object |
