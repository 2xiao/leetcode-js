import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as u,c as d,a as s,b as n,d as a,w as e,e as p}from"./app-46v7IqC8.js";const r={},k={id:"_234-palindrome-linked-list",tabindex:"-1"},v=s("a",{class:"header-anchor",href:"#_234-palindrome-linked-list","aria-hidden":"true"},"#",-1),m={href:"https://leetcode.com/problems/palindrome-linked-list/",target:"_blank",rel:"noopener noreferrer"},b=s("code",null,"栈",-1),h=s("code",null,"递归",-1),f=s("code",null,"链表",-1),_=s("code",null,"双指针",-1),x=p(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Given a singly linked list, determine if it is a palindrome.</p><p><strong>Example 1</strong>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Input: 1-&gt;2
Output: false
...
Output: true
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Follow up</strong>:</p><p>Could you do it in O(n) time and O(1) space?</p><h2 id="题目大意" tabindex="-1"><a class="header-anchor" href="#题目大意" aria-hidden="true">#</a> 题目大意</h2><p>判断一个链表是否是回文链表。要求时间复杂度 O(n)，空间复杂度 O(1)。</p><h2 id="解题思路" tabindex="-1"><a class="header-anchor" href="#解题思路" aria-hidden="true">#</a> 解题思路</h2>`,11),w=p(`<ul><li>先找到中间结点，然后反转中间结点后面到结尾的所有结点；</li><li>最后依次判断头结点开始的结点和中间结点往后开始的结点是否相等；</li><li>如果一直相等，就是回文链表，如果有不相等的，直接返回不是回文链表。</li></ul><h2 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function g(y,L){const l=o("ExternalLinkIcon"),i=o("font"),t=o("RouterLink");return u(),d("div",null,[s("h1",k,[v,n(),s("a",m,[n("234. Palindrome Linked List"),a(l)])]),s("p",null,[n("🟢 "),a(i,{color:"#15bd66"},{default:e(()=>[n("Esay")]),_:1}),n("  🔖  "),a(t,{to:"/leetcode/outline/tag/stack.html"},{default:e(()=>[b]),_:1}),n(),a(t,{to:"/leetcode/outline/tag/recursion.html"},{default:e(()=>[h]),_:1}),n(),a(t,{to:"/leetcode/outline/tag/linked-list.html"},{default:e(()=>[f]),_:1}),n(),a(t,{to:"/leetcode/outline/tag/two-pointers.html"},{default:e(()=>[_]),_:1})]),x,s("p",null,[n("这道题只需要在 "),a(t,{to:"/leetcode/problem/0143.html"},{default:e(()=>[n("第 143 题")]),_:1}),n(" 上面改改就可以了，思路是完全一致的。")]),w])}const O=c(r,[["render",g],["__file","0234.html.vue"]]);export{O as default};
