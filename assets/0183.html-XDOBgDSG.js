import{_ as u,r as t,o as p,c as m,a as e,b as n,d as a,w as s,e as v}from"./app-11q7myLR.js";const b={},h=e("h1",{id:"_183-从不订购的客户",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_183-从不订购的客户","aria-hidden":"true"},"#"),n(" 183. 从不订购的客户")],-1),k=e("code",null,"数据库",-1),g={href:"https://leetcode.cn/problems/customers-who-never-order",target:"_blank",rel:"noopener noreferrer"},x=e("code",null,"力扣",-1),_={href:"https://leetcode.com/problems/customers-who-never-order",target:"_blank",rel:"noopener noreferrer"},f=e("code",null,"LeetCode",-1),y=v(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Table: <code>Customers</code></p><blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+---------+
| Column Name | Type    |
+-------------+---------+
| id          | int     |
| name        | varchar |
