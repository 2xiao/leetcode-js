import{_ as c,r as i,o as r,c as u,a as n,b as s,d as a,w as e,e as d}from"./app-EEsOQbPo.js";const m={},v={id:"_48-rotate-image",tabindex:"-1"},k=n("a",{class:"header-anchor",href:"#_48-rotate-image","aria-hidden":"true"},"#",-1),b={href:"https://leetcode.com/problems/rotate-image/",target:"_blank",rel:"noopener noreferrer"},h=n("code",null,"数组",-1),g=n("code",null,"数学",-1),_=n("code",null,"矩阵",-1),x={href:"https://leetcode.com/problems/rotate-image/",target:"_blank",rel:"noopener noreferrer"},f=n("code",null,"LeetCode",-1),w=n("h2",{id:"题目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#题目","aria-hidden":"true"},"#"),s(" 题目")],-1),y=n("p",null,[s("You are given an "),n("em",null,"n"),s(" x "),n("em",null,"n"),s(" 2D matrix representing an image.")],-1),j=n("p",null,"Rotate the image by 90 degrees (clockwise).",-1),D=n("p",null,[n("strong",null,"Note"),s(":")],-1),N={href:"https://en.wikipedia.org/wiki/In-place_algorithm",target:"_blank",rel:"noopener noreferrer"},E=n("strong",null,"DO NOT",-1),L=d(`<p><strong>Example 1</strong>:</p><figure><img src="https://assets.leetcode.com/uploads/2020/08/28/mat1.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    Given input matrix =
    [
      [1,2,3],
      [4,5,6],
      [7,8,9]
...
<span class="token keyword">var</span> <span class="token function-variable function">rotate</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">matrix</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相关题目" tabindex="-1"><a class="header-anchor" href="#相关题目" aria-hidden="true">#</a> 相关题目</h2>`,14),I={href:"https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation",target:"_blank",rel:"noopener noreferrer"},R=n("div",{class:"language-markdown line-numbers-mode","data-ext":"md"},[n("pre",{class:"language-markdown"},[n("code",null,[n("span",{class:"token list punctuation"},"-"),s(),n("span",{class:"token url"},[s("["),n("span",{class:"token content"},"1886. 判断矩阵经轮转后是否一致"),s("]("),n("span",{class:"token url"},"https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation"),s(")")]),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1);function V(B,C){const t=i("ExternalLinkIcon"),l=i("font"),o=i("RouterLink"),p=i("MdDemo");return r(),u("div",null,[n("h1",v,[k,s(),n("a",b,[s("48. Rotate Image"),a(t)])]),n("p",null,[s("🟠 "),a(l,{color:"#ffb800"},{default:e(()=>[s("Medium")]),_:1}),s("  🔖  "),a(o,{to:"/leetcode/outline/tag/array.html"},{default:e(()=>[h]),_:1}),s(),a(o,{to:"/leetcode/outline/tag/mathematics.html"},{default:e(()=>[g]),_:1}),s(),a(o,{to:"/leetcode/outline/tag/matrix.html"},{default:e(()=>[_]),_:1}),s("  🔗 "),n("a",x,[f,a(t)])]),w,y,j,D,n("p",null,[s("You have to rotate the image "),n("strong",null,[n("a",N,[s("in-place"),a(t)])]),s(", which means you have to modify the input 2D matrix directly. "),E,s(" allocate another 2D matrix and do the rotation.")]),L,a(p,{title:"相关题目",id:"md-demo-74"},{default:e(()=>[n("ul",null,[n("li",null,[n("a",I,[s("1886. 判断矩阵经轮转后是否一致"),a(t)])])])]),code:e(()=>[R]),_:1})])}const z=c(m,[["render",V],["__file","0048.html.vue"]]);export{z as default};
