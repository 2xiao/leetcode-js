# -*- coding: utf-8 -*-
leetcode_path = '../../src/'
problem_path = '../../src/problem/'
problem_readme = '../../src/problem/README.md'
config_path = '../../src/.vuepress/sidebar.ts'
solution_path = '../../src/solution/'
solotion_list_path = '../../src/outline/solution_list.md'
plan_list_path = '../../src/outline/plan/'
tag_list_path = '../../src/outline/tag/'
tag_list_readme = '../../src/outline/tag/README.md'
tag_absolute_path = '/outline/tag/'
categories_path = '../origins/categories_list.md'
origin_path = '../origins/'
problem_absolute_path = '/problem/'
