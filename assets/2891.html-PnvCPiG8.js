import{_ as l,r as i,o,c as d,a as n,b as e,d as a,w as r,e as c}from"./app-kgZn1k0Y.js";const p={},u=n("h1",{id:"_2891-方法链",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2891-方法链","aria-hidden":"true"},"#"),e(" 2891. 方法链")],-1),m={href:"https://leetcode.cn/problems/method-chaining",target:"_blank",rel:"noopener noreferrer"},v=n("code",null,"力扣",-1),g={href:"https://leetcode.com/problems/method-chaining",target:"_blank",rel:"noopener noreferrer"},h=n("code",null,"LeetCode",-1),b=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame animals</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| name        | object |
| species     | object |
