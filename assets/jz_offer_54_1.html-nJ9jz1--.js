import{_ as r,r as o,o as i,c as u,a as s,b as n,d as a,w as e,e as c}from"./app-2xmh8P5W.js";const d={},k={id:"剑指-offer-54-二叉搜索树的第-k-大节点",tabindex:"-1"},v=s("a",{class:"header-anchor",href:"#剑指-offer-54-二叉搜索树的第-k-大节点","aria-hidden":"true"},"#",-1),m={href:"https://leetcode.cn/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof/",target:"_blank",rel:"noopener noreferrer"},h=s("code",null,"树",-1),_=s("code",null,"深度优先搜索",-1),f=s("code",null,"二叉搜索树",-1),b=s("code",null,"二叉树",-1),g={href:"https://leetcode.cn/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof/",target:"_blank",rel:"noopener noreferrer"},y=s("code",null,"LeetCode",-1),w=c(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>某公司组织架构以二叉搜索树形式记录，节点值为处于该职位的员工编号。请返回第 cnt 大的员工编号。</p><p><strong>示例 1</strong>：</p><blockquote><p>输入：root = [7, 3, 9, 1, 5], cnt = 2</p><p>输出：7</p></blockquote><pre><code>    7
   / \\
  3   9
 / \\
1   5
