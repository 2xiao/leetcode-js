import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as l,c as u,a as s,b as n,d as a,w as e,e as d}from"./app-46v7IqC8.js";const r={},k={id:"_225-implement-stack-using-queues",tabindex:"-1"},m=s("a",{class:"header-anchor",href:"#_225-implement-stack-using-queues","aria-hidden":"true"},"#",-1),v={href:"https://leetcode.com/problems/implement-stack-using-queues/",target:"_blank",rel:"noopener noreferrer"},h=s("code",null,"栈",-1),b=s("code",null,"设计",-1),f=s("code",null,"队列",-1),_=d(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Implement a last-in-first-out (LIFO) stack using only two queues. The implemented stack should support all the functions of a normal stack (<code>push</code>, <code>top</code>, <code>pop</code>, and <code>empty</code>).</p><p>Implement the <code>MyStack</code> class:</p><ul><li><code>void push(int x)</code> Pushes element <code>x</code> to the top of the stack.</li><li><code>int pop()</code> Removes the element on the top of the stack and returns it.</li><li><code>int top()</code> Returns the element on the top of the stack.</li><li><code>boolean empty()</code> Returns true if the stack is empty, false otherwise.</li></ul><p><strong>Example</strong>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
