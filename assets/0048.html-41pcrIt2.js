import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as l,c as r,a as n,b as s,d as a,w as t,e as u}from"./app-mTwTgYgE.js";const d={},k={id:"_48-rotate-image",tabindex:"-1"},m=n("a",{class:"header-anchor",href:"#_48-rotate-image","aria-hidden":"true"},"#",-1),v={href:"https://leetcode.com/problems/rotate-image/",target:"_blank",rel:"noopener noreferrer"},h=n("code",null,"数组",-1),b=n("code",null,"数学",-1),_=n("code",null,"矩阵",-1),g=n("h2",{id:"题目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#题目","aria-hidden":"true"},"#"),s(" 题目")],-1),f=n("p",null,[s("You are given an "),n("em",null,"n"),s(" x "),n("em",null,"n"),s(" 2D matrix representing an image.")],-1),x=n("p",null,"Rotate the image by 90 degrees (clockwise).",-1),y=n("p",null,[n("strong",null,"Note"),s(":")],-1),w={href:"https://en.wikipedia.org/wiki/In-place_algorithm",target:"_blank",rel:"noopener noreferrer"},j=n("strong",null,"DO NOT",-1),N=u(`<p><strong>Example 1</strong>:</p><figure><img src="https://assets.leetcode.com/uploads/2020/08/28/mat1.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>Given input matrix =
[
  [1,2,3],
  [4,5,6],
  [7,8,9]
