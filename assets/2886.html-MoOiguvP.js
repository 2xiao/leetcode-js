import{_ as i,r as d,o as l,c as r,a as e,b as n,d as a,w as c,e as o}from"./app-ATuw4JGh.js";const u={},p=e("h1",{id:"_2886-改变数据类型",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_2886-改变数据类型","aria-hidden":"true"},"#"),n(" 2886. 改变数据类型")],-1),v={href:"https://leetcode.cn/problems/change-data-type",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"力扣",-1),b={href:"https://leetcode.com/problems/change-data-type",target:"_blank",rel:"noopener noreferrer"},g=e("code",null,"LeetCode",-1),h=o(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><blockquote><p>DataFrame students</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+--------+
| Column Name | Type   |
+-------------+--------+
| student_id  | int    |
| name        | object |
