import{_ as o,r as a,o as c,c as r,a as e,b as n,d as t,w as i,f as u,e as p}from"./app-aQeLbVW9.js";const v={},m=e("h1",{id:"_1068-产品销售分析-i",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1068-产品销售分析-i","aria-hidden":"true"},"#"),n(" 1068. 产品销售分析 I")],-1),b=e("code",null,"数据库",-1),h={href:"https://leetcode.cn/problems/product-sales-analysis-i",target:"_blank",rel:"noopener noreferrer"},_=e("code",null,"力扣",-1),g={href:"https://leetcode.com/problems/product-sales-analysis-i",target:"_blank",rel:"noopener noreferrer"},x=e("code",null,"LeetCode",-1),y=p(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Table: <code>Sales</code></p><blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+-------+
| Column Name | Type  |
+-------------+-------+
| sale_id     | int   |
| product_id  | int   |
