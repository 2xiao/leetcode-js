import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as e,o as c,c as r,a as s,b as n,d as a,w as t,e as d}from"./app-KjdrhnEZ.js";const u={},k={id:"_61-rotate-list",tabindex:"-1"},v=s("a",{class:"header-anchor",href:"#_61-rotate-list","aria-hidden":"true"},"#",-1),m={href:"https://leetcode.com/problems/rotate-list/description/",target:"_blank",rel:"noopener noreferrer"},h=s("code",null,"链表",-1),b=s("code",null,"双指针",-1),g=d(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Given a linked list, rotate the list to the right by k places, where k is non-negative.</p><p><strong>Example 1</strong>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Input: 1-&gt;2-&gt;3-&gt;4-&gt;5-&gt;NULL, k = 2
Output: 4-&gt;5-&gt;1-&gt;2-&gt;3-&gt;NULL
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Explanation:</p><ul><li>rotate 1 steps to the right: 5-&gt;1-&gt;2-&gt;3-&gt;4-&gt;NULL</li><li>rotate 2 steps to the right: 4-&gt;5-&gt;1-&gt;2-&gt;3-&gt;NULL</li></ul><p><strong>Example 2</strong>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Input: 0-&gt;1-&gt;2-&gt;NULL, k = 4
Output: 2-&gt;0-&gt;1-&gt;NULL
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Explanation:</p><ul><li>rotate 1 steps to the right: 2-&gt;0-&gt;1-&gt;NULL</li><li>rotate 2 steps to the right: 1-&gt;2-&gt;0-&gt;NULL</li><li>rotate 3 steps to the right: 0-&gt;1-&gt;2-&gt;NULL</li><li>rotate 4 steps to the right: 2-&gt;0-&gt;1-&gt;NULL</li></ul><h2 id="题目大意" tabindex="-1"><a class="header-anchor" href="#题目大意" aria-hidden="true">#</a> 题目大意</h2><p>旋转链表 K 次。</p><h2 id="解题思路" tabindex="-1"><a class="header-anchor" href="#解题思路" aria-hidden="true">#</a> 解题思路</h2><p>这道题需要注意的点是，K 可能很大，K = 2000000000 ，如果是循环肯定会超时。应该找出 O(n) 的复杂度的算法才行。由于是循环旋转，最终状态其实是确定的，利用链表的长度取余可以得到链表的最终旋转结果。</p><h2 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function x(_,f){const o=e("ExternalLinkIcon"),l=e("font"),p=e("RouterLink");return c(),r("div",null,[s("h1",k,[v,n(),s("a",m,[n("61. Rotate List"),a(o)])]),s("p",null,[n("🟠 "),a(l,{color:"#ffb800"},{default:t(()=>[n("Medium")]),_:1}),n("  🔖  "),a(p,{to:"/leetcode/outline/tag/linked-list.html"},{default:t(()=>[h]),_:1}),n(),a(p,{to:"/leetcode/outline/tag/two-pointers.html"},{default:t(()=>[b]),_:1})]),g])}const y=i(u,[["render",x],["__file","0061.html.vue"]]);export{y as default};
