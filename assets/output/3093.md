---
title: 3093. 最长公共后缀查询
description: LeetCode,3093. 最长公共后缀查询,最长公共后缀查询,Longest Common Suffix Queries,解题思路,字典树,数组,字符串
keywords:
  - LeetCode
  - 3093. 最长公共后缀查询
  - 最长公共后缀查询
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`字典树`](/tag/trie.md) [`数组`](/tag/array.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/longest-common-suffix-queries) [`LeetCode`](https://leetcode.com/problems/longest-common-suffix-queries)
