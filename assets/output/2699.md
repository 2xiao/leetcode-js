---
title: 2699. 修改图中的边权
description: LeetCode 2699. 修改图中的边权题解，Modify Graph Edge Weights，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2699. 修改图中的边权
  - 修改图中的边权
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`图`](/tag/graph.md) [`最短路`](/tag/shortest-path.md) [`堆（优先队列）`](/tag/heap-priority-queue.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/modify-graph-edge-weights) [`LeetCode`](https://leetcode.com/problems/modify-graph-edge-weights)
