...
| 2743 | 计算没有重复字符的子字符串数量 🔒 |  |  [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md) [`滑动窗口`](/tag/sliding-window.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/count-substrings-without-repeating-character) [🔗](https://leetcode.com/problems/count-substrings-without-repeating-character) |