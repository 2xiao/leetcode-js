...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`递归`](/outline/tag/recursion.md) [`字符串`](/outline/tag/string.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/special-binary-string)
...
| 2533 | [好二进制字符串的数量](https://leetcode.com/problems/number-of-good-binary-strings) |  |  [`动态规划`](/outline/tag/dynamic-programming.md) | <font color=#ffb800>Medium</font> |
