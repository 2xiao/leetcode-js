---
title: 818. 赛车
description: LeetCode 818. 赛车题解，Race Car，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 818. 赛车
  - 赛车
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/race-car) [`LeetCode`](https://leetcode.com/problems/race-car)
