...
description: LeetCode 3275. 第 K 近障碍物查询题解，K-th Nearest Obstacle Queries，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 3275. 第 K 近障碍物查询
  - 第 K 近障碍物查询
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`堆（优先队列）`](/tag/heap-priority-queue.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/k-th-nearest-obstacle-queries) [`LeetCode`](https://leetcode.com/problems/k-th-nearest-obstacle-queries)
