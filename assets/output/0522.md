...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 521 | 最长特殊序列 Ⅰ |  |  [`字符串`](/tag/string.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/longest-uncommon-subsequence-i) [🔗](https://leetcode.com/problems/longest-uncommon-subsequence-i) |