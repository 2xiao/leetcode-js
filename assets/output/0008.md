...
> Step 1: "\_\_ -042" (leading whitespace is read and ignored)
>
> > ^
>
...
4. **舍入：** 如果整数数超过 32 位有符号整数范围 `[−231,  2^31 − 1]` ，需要截断这个整数，使其保持在这个范围内。具体来说，小于 `− 2^31` 的整数应该被舍入为 `− 2^31` ，大于 `2^31 − 1` 的整数应该被舍入为 `2^31 − 1` 。
