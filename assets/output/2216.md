...
description: LeetCode,2216. 美化数组的最少删除数,美化数组的最少删除数,Minimum Deletions to Make Array Beautiful,解题思路,栈,贪心,数组
keywords:
  - LeetCode
  - 2216. 美化数组的最少删除数
  - 美化数组的最少删除数
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`栈`](/tag/stack.md) [`贪心`](/tag/greedy.md) [`数组`](/tag/array.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-deletions-to-make-array-beautiful) [`LeetCode`](https://leetcode.com/problems/minimum-deletions-to-make-array-beautiful)
