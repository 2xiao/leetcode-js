...
description: LeetCode,3225. 网格图操作后的最大分数,网格图操作后的最大分数,Maximum Score From Grid Operations,解题思路,数组,动态规划,矩阵,前缀和
keywords:
  - LeetCode
  - 3225. 网格图操作后的最大分数
  - 网格图操作后的最大分数
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md) [`矩阵`](/tag/matrix.md) [`前缀和`](/tag/prefix-sum.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-score-from-grid-operations) [`LeetCode`](https://leetcode.com/problems/maximum-score-from-grid-operations)
