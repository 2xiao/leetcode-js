---
title: 2172. 数组的最大与和
description: LeetCode 2172. 数组的最大与和题解，Maximum AND Sum of Array，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2172. 数组的最大与和
  - 数组的最大与和
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`位运算`](/tag/bit-manipulation.md) [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md) [`状态压缩`](/tag/bitmask.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-and-sum-of-array) [`LeetCode`](https://leetcode.com/problems/maximum-and-sum-of-array)
