...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`队列`](/outline/tag/queue.md) [`动态规划`](/outline/tag/dynamic-programming.md) [`模拟`](/outline/tag/simulation.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/number-of-people-aware-of-a-secret)
