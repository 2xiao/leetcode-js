---
title: 2614. 对角线上的质数
description: LeetCode 2614. 对角线上的质数题解，Prime In Diagonal，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2614. 对角线上的质数
  - 对角线上的质数
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`数学`](/tag/math.md) [`矩阵`](/tag/matrix.md) [`数论`](/tag/number-theory.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/prime-in-diagonal) [`LeetCode`](https://leetcode.com/problems/prime-in-diagonal)
