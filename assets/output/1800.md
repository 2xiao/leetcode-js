...
| 2393 | 严格递增的子数组个数 🔒 |  |  [`数组`](/tag/array.md) [`数学`](/tag/math.md) [`动态规划`](/tag/dynamic-programming.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/count-strictly-increasing-subarrays) [🔗](https://leetcode.com/problems/count-strictly-increasing-subarrays) |