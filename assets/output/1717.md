...
description: LeetCode 1717. 删除子字符串的最大得分题解，Maximum Score From Removing Substrings，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1717. 删除子字符串的最大得分
  - 删除子字符串的最大得分
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`栈`](/tag/stack.md) [`贪心`](/tag/greedy.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-score-from-removing-substrings) [`LeetCode`](https://leetcode.com/problems/maximum-score-from-removing-substrings)
