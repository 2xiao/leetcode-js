...
description: LeetCode 1997. 访问完所有房间的第一天题解，First Day Where You Have Been in All the Rooms，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1997. 访问完所有房间的第一天
  - 访问完所有房间的第一天
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/first-day-where-you-have-been-in-all-the-rooms) [`LeetCode`](https://leetcode.com/problems/first-day-where-you-have-been-in-all-the-rooms)
