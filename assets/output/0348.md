...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 794 | 有效的井字游戏 |  |  [`数组`](/tag/array.md) [`矩阵`](/tag/matrix.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/valid-tic-tac-toe-state) [🔗](https://leetcode.com/problems/valid-tic-tac-toe-state) |