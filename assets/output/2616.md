...
:::: md-demo 相关题目
- [最小绝对差](https://leetcode.com/problems/minimum-absolute-difference)
- [三次操作后最大值与最小值的最小差](https://leetcode.com/problems/minimum-difference-between-largest-and-smallest-value-in-three-moves)
