...
description: LeetCode,2588. 统计美丽子数组数目,统计美丽子数组数目,Count the Number of Beautiful Subarrays,解题思路,位运算,数组,哈希表,前缀和
keywords:
  - LeetCode
  - 2588. 统计美丽子数组数目
  - 统计美丽子数组数目
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`位运算`](/tag/bit-manipulation.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) [`前缀和`](/tag/prefix-sum.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/count-the-number-of-beautiful-subarrays) [`LeetCode`](https://leetcode.com/problems/count-the-number-of-beautiful-subarrays)
