...
description: LeetCode,1247. 交换字符使得字符串相同,交换字符使得字符串相同,Minimum Swaps to Make Strings Equal,解题思路,贪心,数学,字符串
keywords:
  - LeetCode
  - 1247. 交换字符使得字符串相同
  - 交换字符使得字符串相同
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`贪心`](/tag/greedy.md) [`数学`](/tag/math.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-swaps-to-make-strings-equal) [`LeetCode`](https://leetcode.com/problems/minimum-swaps-to-make-strings-equal)
