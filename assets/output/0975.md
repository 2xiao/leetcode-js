---
title: 975. 奇偶跳
description: LeetCode,975. 奇偶跳,奇偶跳,Odd Even Jump,解题思路,栈,数组,动态规划,有序集合,单调栈
keywords:
  - LeetCode
  - 975. 奇偶跳
  - 奇偶跳
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`栈`](/tag/stack.md) [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md) [`有序集合`](/tag/ordered-set.md) [`单调栈`](/tag/monotonic-stack.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/odd-even-jump) [`LeetCode`](https://leetcode.com/problems/odd-even-jump)
