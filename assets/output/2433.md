...
- [形成两个异或相等数组的三元组数目](https://leetcode.com/problems/count-triplets-that-can-form-two-arrays-of-equal-xor)
- [解码异或后的数组](https://leetcode.com/problems/decode-xored-array)
