...
description: LeetCode 3180. 执行操作可获得的最大总奖励 I题解，Maximum Total Reward Using Operations I，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-total-reward-using-operations-i) [`LeetCode`](https://leetcode.com/problems/maximum-total-reward-using-operations-i)
