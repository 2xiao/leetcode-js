...
description: LeetCode,1865. 找出和为指定值的下标对,找出和为指定值的下标对,Finding Pairs With a Certain Sum,解题思路,设计,数组,哈希表
keywords:
  - LeetCode
  - 1865. 找出和为指定值的下标对
  - 找出和为指定值的下标对
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`设计`](/tag/design.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/finding-pairs-with-a-certain-sum) [`LeetCode`](https://leetcode.com/problems/finding-pairs-with-a-certain-sum)
