# [2877. 从表中创建 DataFrame](https://leetcode.com/problems/create-a-dataframe-from-list)

🟢 <font color=#15bd66>Easy</font>&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/create-a-dataframe-from-list)
