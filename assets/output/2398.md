...
description: LeetCode,2398. 预算内的最多机器人数目,预算内的最多机器人数目,Maximum Number of Robots Within Budget,解题思路,队列,数组,二分查找,前缀和,滑动窗口,单调队列,堆（优先队列）
keywords:
  - LeetCode
  - 2398. 预算内的最多机器人数目
  - 预算内的最多机器人数目
