---
title: 646. 最长数对链
description: LeetCode,646. 最长数对链,最长数对链,Maximum Length of Pair Chain,解题思路,贪心,数组,动态规划,排序
keywords:
  - LeetCode
  - 646. 最长数对链
  - 最长数对链
...
| 491 | 非递减子序列 |  |  [`位运算`](/tag/bit-manipulation.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) `1+` | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/non-decreasing-subsequences) [🔗](https://leetcode.com/problems/non-decreasing-subsequences) |
