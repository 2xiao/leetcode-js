...
description: LeetCode,2520. 统计能整除数字的位数,统计能整除数字的位数,Count the Digits That Divide a Number,解题思路,数学
keywords:
  - LeetCode
  - 2520. 统计能整除数字的位数
  - 统计能整除数字的位数
...
| 728 | 自除数 |  |  [`数学`](/tag/math.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/self-dividing-numbers) [🔗](https://leetcode.com/problems/self-dividing-numbers) |