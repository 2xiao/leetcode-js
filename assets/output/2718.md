---
title: 2718. 查询后矩阵的和
description: LeetCode,2718. 查询后矩阵的和,查询后矩阵的和,Sum of Matrix After Queries,解题思路,数组,哈希表
keywords:
  - LeetCode
  - 2718. 查询后矩阵的和
  - 查询后矩阵的和
...
| 598 | 区间加法 II |  |  [`数组`](/tag/array.md) [`数学`](/tag/math.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/range-addition-ii) [🔗](https://leetcode.com/problems/range-addition-ii) |