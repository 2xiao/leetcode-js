...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`并查集`](/outline/tag/union-find.md) [`数组`](/outline/tag/array.md) [`有序集合`](/outline/tag/ordered-set.md) [`前缀和`](/outline/tag/prefix-sum.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/maximum-segment-sum-after-removals)
