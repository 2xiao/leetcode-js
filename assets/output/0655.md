---
title: 655. 输出二叉树
description: LeetCode 655. 输出二叉树题解，Print Binary Tree，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 655. 输出二叉树
  - 输出二叉树
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`树`](/tag/tree.md) [`深度优先搜索`](/tag/depth-first-search.md) [`广度优先搜索`](/tag/breadth-first-search.md) [`二叉树`](/tag/binary-tree.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/print-binary-tree) [`LeetCode`](https://leetcode.com/problems/print-binary-tree)
