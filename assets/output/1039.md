...
description: LeetCode 1039. 多边形三角剖分的最低得分题解，Minimum Score Triangulation of Polygon，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1039. 多边形三角剖分的最低得分
  - 多边形三角剖分的最低得分
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-score-triangulation-of-polygon) [`LeetCode`](https://leetcode.com/problems/minimum-score-triangulation-of-polygon)
