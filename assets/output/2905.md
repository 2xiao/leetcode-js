...
description: LeetCode,2905. 找出满足差值条件的下标 II,找出满足差值条件的下标 II,Find Indices With Index and Value Difference II,解题思路,数组,双指针
keywords:
  - LeetCode
  - 2905. 找出满足差值条件的下标 II
  - 找出满足差值条件的下标 II
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`双指针`](/tag/two-pointers.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/find-indices-with-index-and-value-difference-ii) [`LeetCode`](https://leetcode.com/problems/find-indices-with-index-and-value-difference-ii)
