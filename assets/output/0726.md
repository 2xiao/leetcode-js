---
title: 726. 原子的数量
description: LeetCode,726. 原子的数量,原子的数量,Number of Atoms,解题思路,栈,哈希表,字符串,排序
keywords:
  - LeetCode
  - 726. 原子的数量
  - 原子的数量
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`栈`](/tag/stack.md) [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md) [`排序`](/tag/sorting.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/number-of-atoms) [`LeetCode`](https://leetcode.com/problems/number-of-atoms)
...
| 471 | 编码最短长度的字符串 🔒 |  |  [`字符串`](/tag/string.md) [`动态规划`](/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> | [🀄️](https://leetcode.cn/problems/encode-string-with-shortest-length) [🔗](https://leetcode.com/problems/encode-string-with-shortest-length) |
