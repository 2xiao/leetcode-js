---
title: 816. 模糊坐标
description: LeetCode 816. 模糊坐标题解，Ambiguous Coordinates，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 816. 模糊坐标
  - 模糊坐标
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`字符串`](/tag/string.md) [`回溯`](/tag/backtracking.md) [`枚举`](/tag/enumeration.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/ambiguous-coordinates) [`LeetCode`](https://leetcode.com/problems/ambiguous-coordinates)
