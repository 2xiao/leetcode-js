...
description: LeetCode,3185. 构成整天的下标对数目 II,构成整天的下标对数目 II,Count Pairs That Form a Complete Day II,解题思路,数组,哈希表,计数
keywords:
  - LeetCode
  - 3185. 构成整天的下标对数目 II
  - 构成整天的下标对数目 II
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) [`计数`](/tag/counting.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/count-pairs-that-form-a-complete-day-ii) [`LeetCode`](https://leetcode.com/problems/count-pairs-that-form-a-complete-day-ii)
