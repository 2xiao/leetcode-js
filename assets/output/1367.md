---
title: 1367. 二叉树中的链表
description: LeetCode 1367. 二叉树中的链表题解，Linked List in Binary Tree，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1367. 二叉树中的链表
  - 二叉树中的链表
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`树`](/tag/tree.md) [`深度优先搜索`](/tag/depth-first-search.md) [`链表`](/tag/linked-list.md) [`二叉树`](/tag/binary-tree.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/linked-list-in-binary-tree) [`LeetCode`](https://leetcode.com/problems/linked-list-in-binary-tree)
