...
| 1842 | 下个由相同数字构成的回文串 🔒 |  |  [`双指针`](/tag/two-pointers.md) [`字符串`](/tag/string.md) | <font color=#ff334b>Hard</font> | [🀄️](https://leetcode.cn/problems/next-palindrome-using-same-digits) [🔗](https://leetcode.com/problems/next-palindrome-using-same-digits) |