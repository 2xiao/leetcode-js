---
title: 2227. 加密解密字符串
description: LeetCode,2227. 加密解密字符串,加密解密字符串,Encrypt and Decrypt Strings,解题思路,设计,字典树,数组,哈希表,字符串
keywords:
  - LeetCode
  - 2227. 加密解密字符串
  - 加密解密字符串
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`设计`](/tag/design.md) [`字典树`](/tag/trie.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/encrypt-and-decrypt-strings) [`LeetCode`](https://leetcode.com/problems/encrypt-and-decrypt-strings)
...
| 1804 | 实现 Trie （前缀树） II 🔒 |  |  [`设计`](/tag/design.md) [`字典树`](/tag/trie.md) [`哈希表`](/tag/hash-table.md) `1+` | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/implement-trie-ii-prefix-tree) [🔗](https://leetcode.com/problems/implement-trie-ii-prefix-tree) |
