...
description: LeetCode,2134. 最少交换次数来组合所有的 1 II,最少交换次数来组合所有的 1 II,Minimum Swaps to Group All 1's Together II,解题思路,数组,滑动窗口
keywords:
  - LeetCode
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`滑动窗口`](/tag/sliding-window.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-swaps-to-group-all-1s-together-ii) [`LeetCode`](https://leetcode.com/problems/minimum-swaps-to-group-all-1s-together-ii)
