...
description: LeetCode,352. 将数据流变为多个不相交区间,将数据流变为多个不相交区间,Data Stream as Disjoint Intervals,解题思路,设计,二分查找,有序集合
keywords:
  - LeetCode
  - 352. 将数据流变为多个不相交区间
  - 将数据流变为多个不相交区间
...
| 436 | 寻找右区间 |  |  [`数组`](/tag/array.md) [`二分查找`](/tag/binary-search.md) [`排序`](/tag/sorting.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/find-right-interval) [🔗](https://leetcode.com/problems/find-right-interval) |
