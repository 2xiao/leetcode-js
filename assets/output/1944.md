...
description: LeetCode,1944. 队列中可以看到的人数,队列中可以看到的人数,Number of Visible People in a Queue,解题思路,栈,数组,单调栈
keywords:
  - LeetCode
  - 1944. 队列中可以看到的人数
  - 队列中可以看到的人数
...
| 2282 | 在一个网格中可以看到的人数 🔒 |  |  [`栈`](/tag/stack.md) [`数组`](/tag/array.md) [`矩阵`](/tag/matrix.md) `1+` | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/number-of-people-that-can-be-seen-in-a-grid) [🔗](https://leetcode.com/problems/number-of-people-that-can-be-seen-in-a-grid) |
