---
title: 558. 四叉树交集
description: LeetCode 558. 四叉树交集题解，Logical OR of Two Binary Grids Represented as Quad-Trees，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 558. 四叉树交集
  - 四叉树交集
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`树`](/tag/tree.md) [`分治`](/tag/divide-and-conquer.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/logical-or-of-two-binary-grids-represented-as-quad-trees) [`LeetCode`](https://leetcode.com/problems/logical-or-of-two-binary-grids-represented-as-quad-trees)
