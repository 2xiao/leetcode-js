...
description: LeetCode,2274. 不含特殊楼层的最大连续楼层数,不含特殊楼层的最大连续楼层数,Maximum Consecutive Floors Without Special Floors,解题思路,数组,排序
keywords:
  - LeetCode
  - 2274. 不含特殊楼层的最大连续楼层数
  - 不含特殊楼层的最大连续楼层数
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`排序`](/tag/sorting.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-consecutive-floors-without-special-floors) [`LeetCode`](https://leetcode.com/problems/maximum-consecutive-floors-without-special-floors)
