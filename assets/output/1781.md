...
description: LeetCode 1781. 所有子字符串美丽值之和题解，Sum of Beauty of All Substrings，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1781. 所有子字符串美丽值之和
  - 所有子字符串美丽值之和
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md) [`计数`](/tag/counting.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/sum-of-beauty-of-all-substrings) [`LeetCode`](https://leetcode.com/problems/sum-of-beauty-of-all-substrings)
