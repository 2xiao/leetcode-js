...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数学`](/outline/tag/math.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/reaching-points)
...
| 2849 | [判断能否在给定时间到达单元格](https://leetcode.com/problems/determine-if-a-cell-is-reachable-at-a-given-time) |  |  [`数学`](/outline/tag/math.md) | <font color=#ffb800>Medium</font> |
