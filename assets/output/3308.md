# [3308. 寻找表现最佳的司机](https://leetcode.com/problems/find-top-performing-driver)

🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数据库`](/tag/database.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/find-top-performing-driver)
