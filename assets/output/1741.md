...
description: LeetCode 1741. 查找每个员工花费的总时间题解，Find Total Time Spent by Each Employee，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1741. 查找每个员工花费的总时间
  - 查找每个员工花费的总时间
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数据库`](/tag/database.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/find-total-time-spent-by-each-employee) [`LeetCode`](https://leetcode.com/problems/find-total-time-spent-by-each-employee)
