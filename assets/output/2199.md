...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 1484 | 按日期分组销售产品 |  |  [`数据库`](/tag/database.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/group-sold-products-by-the-date) [🔗](https://leetcode.com/problems/group-sold-products-by-the-date) |