---
title: 935. 骑士拨号器
description: LeetCode 935. 骑士拨号器题解，Knight Dialer，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 935. 骑士拨号器
  - 骑士拨号器
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/knight-dialer) [`LeetCode`](https://leetcode.com/problems/knight-dialer)
