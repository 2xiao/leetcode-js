---
title: 913. 猫和老鼠
description: LeetCode,913. 猫和老鼠,猫和老鼠,Cat and Mouse,解题思路,图,拓扑排序,记忆化搜索,数学,动态规划,博弈
keywords:
  - LeetCode
  - 913. 猫和老鼠
  - 猫和老鼠
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`图`](/tag/graph.md) [`拓扑排序`](/tag/topological-sort.md) [`记忆化搜索`](/tag/memoization.md) [`数学`](/tag/math.md) [`动态规划`](/tag/dynamic-programming.md) [`博弈`](/tag/game-theory.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/cat-and-mouse) [`LeetCode`](https://leetcode.com/problems/cat-and-mouse)
