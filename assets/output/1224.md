---
title: 1224. 最大相等频率
description: LeetCode,1224. 最大相等频率,最大相等频率,Maximum Equal Frequency,解题思路,数组,哈希表
keywords:
  - LeetCode
  - 1224. 最大相等频率
  - 最大相等频率
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-equal-frequency) [`LeetCode`](https://leetcode.com/problems/maximum-equal-frequency)
