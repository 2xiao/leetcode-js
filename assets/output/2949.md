...
description: LeetCode 2949. 统计美丽子字符串 II题解，Count Beautiful Substrings II，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2949. 统计美丽子字符串 II
  - 统计美丽子字符串 II
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`哈希表`](/tag/hash-table.md) [`数学`](/tag/math.md) [`字符串`](/tag/string.md) [`数论`](/tag/number-theory.md) [`前缀和`](/tag/prefix-sum.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/count-beautiful-substrings-ii) [`LeetCode`](https://leetcode.com/problems/count-beautiful-substrings-ii)
