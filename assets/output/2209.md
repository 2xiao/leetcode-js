...
description: LeetCode 2209. 用地毯覆盖后的最少白色砖块题解，Minimum White Tiles After Covering With Carpets，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2209. 用地毯覆盖后的最少白色砖块
  - 用地毯覆盖后的最少白色砖块
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`字符串`](/tag/string.md) [`动态规划`](/tag/dynamic-programming.md) [`前缀和`](/tag/prefix-sum.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-white-tiles-after-covering-with-carpets) [`LeetCode`](https://leetcode.com/problems/minimum-white-tiles-after-covering-with-carpets)
