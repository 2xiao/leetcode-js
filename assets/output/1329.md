...
description: LeetCode 1329. 将矩阵按对角线排序题解，Sort the Matrix Diagonally，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1329. 将矩阵按对角线排序
  - 将矩阵按对角线排序
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`矩阵`](/tag/matrix.md) [`排序`](/tag/sorting.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/sort-the-matrix-diagonally) [`LeetCode`](https://leetcode.com/problems/sort-the-matrix-diagonally)
