---
title: 690. 员工的重要性
description: LeetCode,690. 员工的重要性,员工的重要性,Employee Importance,解题思路,树,深度优先搜索,广度优先搜索,数组,哈希表
keywords:
  - LeetCode
  - 690. 员工的重要性
  - 员工的重要性
...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 339 | 嵌套列表加权和 🔒 |  |  [`深度优先搜索`](/tag/depth-first-search.md) [`广度优先搜索`](/tag/breadth-first-search.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/nested-list-weight-sum) [🔗](https://leetcode.com/problems/nested-list-weight-sum) |