...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`并查集`](/outline/tag/union-find.md) [`图`](/outline/tag/graph.md) [`最小生成树`](/outline/tag/minimum-spanning-tree.md) [`排序`](/outline/tag/sorting.md) [`强连通分量`](/outline/tag/strongly-connected-component.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree)
