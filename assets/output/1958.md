---
title: 1958. 检查操作是否合法
description: LeetCode 1958. 检查操作是否合法题解，Check if Move is Legal，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1958. 检查操作是否合法
  - 检查操作是否合法
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`枚举`](/tag/enumeration.md) [`矩阵`](/tag/matrix.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/check-if-move-is-legal) [`LeetCode`](https://leetcode.com/problems/check-if-move-is-legal)
