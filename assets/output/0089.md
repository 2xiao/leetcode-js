---
title: 89. 格雷编码
description: LeetCode,89. 格雷编码,格雷编码,Gray Code,解题思路,位运算,数学,回溯
keywords:
  - LeetCode
  - 89. 格雷编码
  - 格雷编码
...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 717 | 1 比特与 2 比特字符 |  |  [`数组`](/tag/array.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/1-bit-and-2-bit-characters) [🔗](https://leetcode.com/problems/1-bit-and-2-bit-characters) |