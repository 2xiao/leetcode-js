...
description: LeetCode,1585. 检查字符串是否可以通过排序子字符串得到另一个字符串,检查字符串是否可以通过排序子字符串得到另一个字符串,Check If String Is Transformable With Substring Sort Operations,解题思路,贪心,字符串,排序
keywords:
  - LeetCode
