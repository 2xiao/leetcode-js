---
title: 1001. 网格照明
description: LeetCode 1001. 网格照明题解，Grid Illumination，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1001. 网格照明
  - 网格照明
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/grid-illumination) [`LeetCode`](https://leetcode.com/problems/grid-illumination)
