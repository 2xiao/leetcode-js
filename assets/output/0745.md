---
title: 745. 前缀和后缀搜索
description: LeetCode 745. 前缀和后缀搜索题解，Prefix and Suffix Search，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 745. 前缀和后缀搜索
  - 前缀和后缀搜索
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`设计`](/tag/design.md) [`字典树`](/tag/trie.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/prefix-and-suffix-search) [`LeetCode`](https://leetcode.com/problems/prefix-and-suffix-search)
