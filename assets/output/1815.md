...
description: LeetCode,1815. 得到新鲜甜甜圈的最多组数,得到新鲜甜甜圈的最多组数,Maximum Number of Groups Getting Fresh Donuts,解题思路,位运算,记忆化搜索,数组,动态规划,状态压缩
keywords:
  - LeetCode
  - 1815. 得到新鲜甜甜圈的最多组数
  - 得到新鲜甜甜圈的最多组数
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`位运算`](/tag/bit-manipulation.md) [`记忆化搜索`](/tag/memoization.md) [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md) [`状态压缩`](/tag/bitmask.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-number-of-groups-getting-fresh-donuts) [`LeetCode`](https://leetcode.com/problems/maximum-number-of-groups-getting-fresh-donuts)
