---
title: 1938. 查询最大基因差
description: LeetCode,1938. 查询最大基因差,查询最大基因差,Maximum Genetic Difference Query,解题思路,位运算,深度优先搜索,字典树,数组,哈希表
keywords:
  - LeetCode
  - 1938. 查询最大基因差
  - 查询最大基因差
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`位运算`](/tag/bit-manipulation.md) [`深度优先搜索`](/tag/depth-first-search.md) [`字典树`](/tag/trie.md) [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-genetic-difference-query) [`LeetCode`](https://leetcode.com/problems/maximum-genetic-difference-query)
