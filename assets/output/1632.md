...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`并查集`](/outline/tag/union-find.md) [`图`](/outline/tag/graph.md) [`拓扑排序`](/outline/tag/topological-sort.md) [`数组`](/outline/tag/array.md) [`矩阵`](/outline/tag/matrix.md) [`排序`](/outline/tag/sorting.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/rank-transform-of-a-matrix)
