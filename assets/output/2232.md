...
description: LeetCode,2232. 向表达式添加括号后的最小结果,向表达式添加括号后的最小结果,Minimize Result by Adding Parentheses to Expression,解题思路,字符串,枚举
keywords:
  - LeetCode
  - 2232. 向表达式添加括号后的最小结果
  - 向表达式添加括号后的最小结果
...
| 640 | 求解方程 |  |  [`数学`](/tag/math.md) [`字符串`](/tag/string.md) [`模拟`](/tag/simulation.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/solve-the-equation) [🔗](https://leetcode.com/problems/solve-the-equation) |