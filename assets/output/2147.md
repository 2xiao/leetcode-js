---
title: 2147. 分隔长廊的方案数
description: LeetCode,2147. 分隔长廊的方案数,分隔长廊的方案数,Number of Ways to Divide a Long Corridor,解题思路,数学,字符串,动态规划
keywords:
  - LeetCode
  - 2147. 分隔长廊的方案数
  - 分隔长廊的方案数
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数学`](/tag/math.md) [`字符串`](/tag/string.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/number-of-ways-to-divide-a-long-corridor) [`LeetCode`](https://leetcode.com/problems/number-of-ways-to-divide-a-long-corridor)
