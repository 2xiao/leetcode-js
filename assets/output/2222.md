---
title: 2222. 选择建筑的方案数
description: LeetCode 2222. 选择建筑的方案数题解，Number of Ways to Select Buildings，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2222. 选择建筑的方案数
  - 选择建筑的方案数
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`字符串`](/tag/string.md) [`动态规划`](/tag/dynamic-programming.md) [`前缀和`](/tag/prefix-sum.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/number-of-ways-to-select-buildings) [`LeetCode`](https://leetcode.com/problems/number-of-ways-to-select-buildings)
