...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/outline/tag/array.md) [`数学`](/outline/tag/math.md) [`组合数学`](/outline/tag/combinatorics.md) [`前缀和`](/outline/tag/prefix-sum.md) [`模拟`](/outline/tag/simulation.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/find-the-n-th-value-after-k-seconds)
