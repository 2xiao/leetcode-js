# [3328. 查找每个州的城市 II](https://leetcode.com/problems/find-cities-in-each-state-ii)

🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数据库`](/tag/database.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/find-cities-in-each-state-ii)
