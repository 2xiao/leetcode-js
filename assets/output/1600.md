---
title: 1600. 王位继承顺序
description: LeetCode,1600. 王位继承顺序,王位继承顺序,Throne Inheritance,解题思路,树,深度优先搜索,设计,哈希表
keywords:
  - LeetCode
  - 1600. 王位继承顺序
  - 王位继承顺序
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`树`](/tag/tree.md) [`深度优先搜索`](/tag/depth-first-search.md) [`设计`](/tag/design.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/throne-inheritance) [`LeetCode`](https://leetcode.com/problems/throne-inheritance)
