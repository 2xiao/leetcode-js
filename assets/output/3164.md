...
description: LeetCode 3164. 优质数对的总数 II题解，Find the Number of Good Pairs II，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 3164. 优质数对的总数 II
  - 优质数对的总数 II
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/find-the-number-of-good-pairs-ii) [`LeetCode`](https://leetcode.com/problems/find-the-number-of-good-pairs-ii)
