...
description: LeetCode,3031. 将单词恢复初始状态所需的最短时间 II,将单词恢复初始状态所需的最短时间 II,Minimum Time to Revert Word to Initial State II,解题思路,字符串,字符串匹配,哈希函数,滚动哈希
keywords:
  - LeetCode
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`字符串`](/tag/string.md) [`字符串匹配`](/tag/string-matching.md) [`哈希函数`](/tag/hash-function.md) [`滚动哈希`](/tag/rolling-hash.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/minimum-time-to-revert-word-to-initial-state-ii) [`LeetCode`](https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-ii)
