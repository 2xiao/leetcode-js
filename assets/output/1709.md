...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 2228 | 7 天内两次购买的用户 🔒 |  |  [`数据库`](/tag/database.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/users-with-two-purchases-within-seven-days) [🔗](https://leetcode.com/problems/users-with-two-purchases-within-seven-days) |