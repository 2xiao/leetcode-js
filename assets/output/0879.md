---
title: 879. 盈利计划
description: LeetCode 879. 盈利计划题解，Profitable Schemes，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 879. 盈利计划
  - 盈利计划
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/profitable-schemes) [`LeetCode`](https://leetcode.com/problems/profitable-schemes)
