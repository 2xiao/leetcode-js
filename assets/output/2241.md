...
description: LeetCode,2241. 设计一个 ATM 机器,设计一个 ATM 机器,Design an ATM Machine,解题思路,贪心,设计,数组
keywords:
  - LeetCode
  - 2241. 设计一个 ATM 机器
  - 设计一个 ATM 机器
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`贪心`](/tag/greedy.md) [`设计`](/tag/design.md) [`数组`](/tag/array.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/design-an-atm-machine) [`LeetCode`](https://leetcode.com/problems/design-an-atm-machine)
