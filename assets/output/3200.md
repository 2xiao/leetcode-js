---
title: 3200. 三角形的最大高度
description: LeetCode 3200. 三角形的最大高度题解，Maximum Height of a Triangle，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 3200. 三角形的最大高度
  - 三角形的最大高度
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`枚举`](/tag/enumeration.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/maximum-height-of-a-triangle) [`LeetCode`](https://leetcode.com/problems/maximum-height-of-a-triangle)
