...
description: LeetCode 3162. 优质数对的总数 I题解，Find the Number of Good Pairs I，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 3162. 优质数对的总数 I
  - 优质数对的总数 I
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/find-the-number-of-good-pairs-i) [`LeetCode`](https://leetcode.com/problems/find-the-number-of-good-pairs-i)
...
如果 `nums1[i]` 可以除尽 `nums2[j] * k`，则称数对 `(i, j)` 为 **优质数对** （`0 <= i <= n - 1`,
`0 <= j <= m - 1`）。
