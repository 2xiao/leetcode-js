...
description: LeetCode,2451. 差值数组不同的字符串,差值数组不同的字符串,Odd String Difference,解题思路,数组,哈希表,字符串
keywords:
  - LeetCode
  - 2451. 差值数组不同的字符串
  - 差值数组不同的字符串
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`哈希表`](/tag/hash-table.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/odd-string-difference) [`LeetCode`](https://leetcode.com/problems/odd-string-difference)
