...
description: LeetCode,236. 二叉树的最近公共祖先,二叉树的最近公共祖先,Lowest Common Ancestor of a Binary Tree,解题思路,树,深度优先搜索,二叉树
keywords:
  - LeetCode
  - 236. 二叉树的最近公共祖先
  - 二叉树的最近公共祖先
...
| 1644 | 二叉树的最近公共祖先 II 🔒 |  |  [`树`](/tag/tree.md) [`深度优先搜索`](/tag/depth-first-search.md) [`二叉树`](/tag/binary-tree.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree-ii) [🔗](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-ii) |
| 1650 | 二叉树的最近公共祖先 III 🔒 |  |  [`树`](/tag/tree.md) [`哈希表`](/tag/hash-table.md) [`双指针`](/tag/two-pointers.md) `1+` | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree-iii) [🔗](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-iii) |
