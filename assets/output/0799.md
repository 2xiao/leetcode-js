---
title: 799. 香槟塔
description: LeetCode,799. 香槟塔,香槟塔,Champagne Tower,解题思路,动态规划
keywords:
  - LeetCode
  - 799. 香槟塔
  - 香槟塔
...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 2189 | 建造纸牌屋的方法数 🔒 |  |  [`数学`](/tag/math.md) [`动态规划`](/tag/dynamic-programming.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/number-of-ways-to-build-house-of-cards) [🔗](https://leetcode.com/problems/number-of-ways-to-build-house-of-cards) |