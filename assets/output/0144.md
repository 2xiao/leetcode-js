...
- [验证二叉搜索树的前序遍历序列](https://leetcode.com/problems/verify-preorder-sequence-in-binary-search-tree)
- [N 叉树的前序遍历](https://leetcode.com/problems/n-ary-tree-preorder-traversal)
