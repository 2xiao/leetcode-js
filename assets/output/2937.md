---
title: 2937. 使三个字符串相等
description: LeetCode 2937. 使三个字符串相等题解，Make Three Strings Equal，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2937. 使三个字符串相等
  - 使三个字符串相等
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/make-three-strings-equal) [`LeetCode`](https://leetcode.com/problems/make-three-strings-equal)
