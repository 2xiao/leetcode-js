...
description: LeetCode 2745. 构造最长的新字符串题解，Construct the Longest New String，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2745. 构造最长的新字符串
  - 构造最长的新字符串
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`贪心`](/tag/greedy.md) [`脑筋急转弯`](/tag/brainteaser.md) [`数学`](/tag/math.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/construct-the-longest-new-string) [`LeetCode`](https://leetcode.com/problems/construct-the-longest-new-string)
