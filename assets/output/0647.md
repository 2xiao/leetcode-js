---
title: 647. 回文子串
description: LeetCode 647. 回文子串题解，Palindromic Substrings，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 647. 回文子串
  - 回文子串
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`双指针`](/tag/two-pointers.md) [`字符串`](/tag/string.md) [`动态规划`](/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/palindromic-substrings) [`LeetCode`](https://leetcode.com/problems/palindromic-substrings)
