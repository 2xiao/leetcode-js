...
description: LeetCode,3154. 到达第 K 级台阶的方案数,到达第 K 级台阶的方案数,Find Number of Ways to Reach the K-th Stair,解题思路,位运算,记忆化搜索,数学,动态规划,组合数学
keywords:
  - LeetCode
  - 3154. 到达第 K 级台阶的方案数
  - 到达第 K 级台阶的方案数
...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`位运算`](/tag/bit-manipulation.md) [`记忆化搜索`](/tag/memoization.md) [`数学`](/tag/math.md) [`动态规划`](/tag/dynamic-programming.md) [`组合数学`](/tag/combinatorics.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/find-number-of-ways-to-reach-the-k-th-stair) [`LeetCode`](https://leetcode.com/problems/find-number-of-ways-to-reach-the-k-th-stair)
