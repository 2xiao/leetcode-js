...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`几何`](/outline/tag/geometry.md) [`数学`](/outline/tag/math.md) [`拒绝采样`](/outline/tag/rejection-sampling.md) [`随机化`](/outline/tag/randomized.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/generate-random-point-in-a-circle)
