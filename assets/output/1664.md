# [1664. 生成平衡数组的方案数](https://leetcode.com/problems/ways-to-make-a-fair-array)

🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/leetcode/outline/tag/array.md) [`前缀和`](/leetcode/outline/tag/prefix-sum.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/ways-to-make-a-fair-array)
