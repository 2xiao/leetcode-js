...
- [找出不同元素数目差数组](https://leetcode.com/problems/find-the-distinct-difference-array)
- [K 秒后第 N 个元素的值](https://leetcode.com/problems/find-the-n-th-value-after-k-seconds)
