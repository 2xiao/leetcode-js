...
description: LeetCode 1663. 具有给定数值的最小字符串题解，Smallest String With A Given Numeric Value，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 1663. 具有给定数值的最小字符串
  - 具有给定数值的最小字符串
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`贪心`](/tag/greedy.md) [`字符串`](/tag/string.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/smallest-string-with-a-given-numeric-value) [`LeetCode`](https://leetcode.com/problems/smallest-string-with-a-given-numeric-value)
