...
description: LeetCode,2069. 模拟行走机器人 II,模拟行走机器人 II,Walking Robot Simulation II,解题思路,设计,模拟
keywords:
  - LeetCode
  - 2069. 模拟行走机器人 II
  - 模拟行走机器人 II
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`设计`](/tag/design.md) [`模拟`](/tag/simulation.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/walking-robot-simulation-ii) [`LeetCode`](https://leetcode.com/problems/walking-robot-simulation-ii)
