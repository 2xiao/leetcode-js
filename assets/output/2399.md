...
| 821 | 字符的最短距离 |  |  [`数组`](/tag/array.md) [`双指针`](/tag/two-pointers.md) [`字符串`](/tag/string.md) | <font color=#15bd66>Easy</font> | [🀄️](https://leetcode.cn/problems/shortest-distance-to-a-character) [🔗](https://leetcode.com/problems/shortest-distance-to-a-character) |