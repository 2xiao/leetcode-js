...
description: LeetCode,2970. 统计移除递增子数组的数目 I,统计移除递增子数组的数目 I,Count the Number of Incremovable Subarrays I,解题思路,数组,双指针,二分查找,枚举
keywords:
  - LeetCode
  - 2970. 统计移除递增子数组的数目 I
  - 统计移除递增子数组的数目 I
...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`数组`](/tag/array.md) [`双指针`](/tag/two-pointers.md) [`二分查找`](/tag/binary-search.md) [`枚举`](/tag/enumeration.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/count-the-number-of-incremovable-subarrays-i) [`LeetCode`](https://leetcode.com/problems/count-the-number-of-incremovable-subarrays-i)
