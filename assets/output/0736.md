---
title: 736. Lisp 语法解析
description: LeetCode,736. Lisp 语法解析,Lisp 语法解析,Parse Lisp Expression,解题思路,栈,递归,哈希表,字符串
keywords:
  - LeetCode
  - 736. Lisp 语法解析
  - Lisp 语法解析
...
| 题号 | 标题 | 题解 | 标签 | 难度 | 力扣 |
| :------: | :------ | :------: | :------ | :------ | :------: |
| 439 | 三元表达式解析器 🔒 |  |  [`栈`](/tag/stack.md) [`递归`](/tag/recursion.md) [`字符串`](/tag/string.md) | <font color=#ffb800>Medium</font> | [🀄️](https://leetcode.cn/problems/ternary-expression-parser) [🔗](https://leetcode.com/problems/ternary-expression-parser) |
