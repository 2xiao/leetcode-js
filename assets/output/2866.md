---
title: 2866. 美丽塔 II
description: LeetCode 2866. 美丽塔 II题解，Beautiful Towers II，包含解题思路、复杂度分析以及完整的 JavaScript 代码实现。
keywords:
  - LeetCode
  - 2866. 美丽塔 II
  - 美丽塔 II
...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`栈`](/tag/stack.md) [`数组`](/tag/array.md) [`单调栈`](/tag/monotonic-stack.md)&emsp; 🔗&ensp;[`力扣`](https://leetcode.cn/problems/beautiful-towers-ii) [`LeetCode`](https://leetcode.com/problems/beautiful-towers-ii)
