import{_ as t,r as d,o,c,a as e,b as n,d as i,w as a,e as u}from"./app-B5EG-zH0.js";const v={},m=e("h1",{id:"_584-寻找用户推荐人",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_584-寻找用户推荐人","aria-hidden":"true"},"#"),n(" 584. 寻找用户推荐人")],-1),p=e("code",null,"数据库",-1),b={href:"https://leetcode.cn/problems/find-customer-referee",target:"_blank",rel:"noopener noreferrer"},h=e("code",null,"力扣",-1),g={href:"https://leetcode.com/problems/find-customer-referee",target:"_blank",rel:"noopener noreferrer"},_=e("code",null,"LeetCode",-1),f=u(`<h2 id="题目" tabindex="-1"><a class="header-anchor" href="#题目" aria-hidden="true">#</a> 题目</h2><p>Table: <code>Customer</code></p><blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>+-------------+---------+
| Column Name | Type    |
+-------------+---------+
| id          | int     |
| name        | varchar |
