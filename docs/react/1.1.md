...
项目框架搭建包括：
* 定义项目结构（Mono-repo）
* 定义开发规范（eslint、commitlint、tsc、代码风格）
* 选择打包工具（rollup）
...
至此，我们的项目框架就搭建完成了，相关代码可在`git tag v1.1`查看，详见：[https://github.com/2xiao/my-react/tree/v1.1](https://github.com/2xiao/my-react/tree/v1.1)