...
| 2374 | [边积分最高的节点](https://leetcode.com/problems/node-with-highest-edge-score/) |  | `图` `哈希表` | <font color=#ffb800>Medium</font> |
...
| 2508 | [添加边使所有节点度数都为偶数](https://leetcode.com/problems/add-edges-to-make-degrees-of-all-nodes-even/) |  | `图` `哈希表` | <font color=#ff334b>Hard</font> |
