...
## 关于本书
本书是LeetCode Cookbook系列的JS版本，系列发起者是[@halfrost](https://github.com/halfrost)，他的LeetCode-Go[项目](https://github.com/halfrost/LeetCode-Go)和[书籍](https://books.halfrost.com/leetcode/)有过万的star和过亿的pv。在他的鼓励下，我开始写JS版本。一边刷题，一边记录一下做题心得，解题方法。对于自己来说，把解题思路和代码详细写下俩，让人能轻松理解，也是一种提高。


{{< /columns >}}

<img src="http://mat1.gtimg.com/www/js/news/leetcode-js-logo.png" alt="logo" height="600" align="right" style="padding-left: 30px;"/>
...
代码都放在 [github repo](https://github.com/2xiao/leetcode-js/tree/master/leetcode) 中，按题号可以搜索到题目。

## 关于书的封面

本书的封面是为了致敬 O'Reilly 动物书，O'Reilly 的封面动物都是稀缺动物，并且画风都是黑白素描风。本书的封面动物是我的猫，名叫小朋友。全书配色也都是绿色，因为这是 AC 的颜色。
